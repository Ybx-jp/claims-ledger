---
id: A0006-stale-fraction-law-single-layer-scoped
kind: claim
stated: 2026-09-02T10:00:00-07:00
author: main
grade: measured
supersedes: A0005-stale-fraction-law-single-layer
...
invariant. The invariance holds for perturbations small relative to the feature norm.
...
sweep confirms the mechanism to three decimals, so the direction is structural. Larger
perturbations leave the linear regime of the untrained layer and were not swept.
