...
- 2026-09-20T17:45:59-07:00 · corroborated · grade: measured · author: main
  ...
  note: `run` gained four lines binding the reach it holds a reading to and passing it down to `effective_pointer` and `orphans`. Nothing was added that appends: the one function is still `append_verdict`, reached from the one call at the end of this section, and the new binding is read-only.
