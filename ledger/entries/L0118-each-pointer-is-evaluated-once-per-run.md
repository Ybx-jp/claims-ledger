...
- 2026-09-20T17:45:59-07:00 · corroborated · grade: measured · author: main
  ...
  note: The per-pointer memo is unchanged and still keyed on the whole pointer. The reach added beside it is computed once for the run rather than per pointer, which is the same discipline applied to a second question.
