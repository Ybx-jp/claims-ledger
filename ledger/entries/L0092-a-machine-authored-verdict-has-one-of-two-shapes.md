...
- 2026-09-11T19:30:01-07:00 · corroborated · grade: measured · author: main
  ...
  note: re-read after the commit that widens an object id to the repository's own hash width. The two shapes a propagated verdict may take are unchanged and are still the only ones admitted under the propagation author; this section moved by the artifact-shape message and the null-id comparison beside them.
