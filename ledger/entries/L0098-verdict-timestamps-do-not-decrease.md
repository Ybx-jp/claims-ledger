...
- 2026-09-11T19:30:01-07:00 · corroborated · grade: measured · author: main
  ...
  note: re-read after the same commit, which touched this section only where the artifact shape is reported. The ordering rule on verdict timestamps is unchanged.
