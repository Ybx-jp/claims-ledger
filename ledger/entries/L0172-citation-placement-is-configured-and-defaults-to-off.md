...
- 2026-09-20T12:56:58-07:00 · corroborated · grade: measured · author: main
  ...
  note: re-read after the commit that adds the `citation-slug` key. The section gained one more check, written like the two beside it and placed after them. The citation-placement check is untouched and still refuses a value outside the three outcomes; the new check is written the same way and placed after it.
