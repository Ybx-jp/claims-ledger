...
- 2026-09-20T17:45:59-07:00 · corroborated · grade: measured · author: main
  ...
  note: The signature gained a `revs` parameter that is handed straight to `readings`. The question is still asked of the ground and not of each verdict: the loop and the lookup it walks are unchanged.
