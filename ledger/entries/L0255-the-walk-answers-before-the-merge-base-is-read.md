...
- 2026-09-24T21:52:23-07:00 · corroborated · grade: measured · author: main
  ...
  note: re-read after #69. ids_in_the_repository returns a dict now, so the one line folding it into the taken ids reads held.keys(); the walk is still read before the merge base.
