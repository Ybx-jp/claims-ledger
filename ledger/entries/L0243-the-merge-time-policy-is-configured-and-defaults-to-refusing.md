...
- 2026-09-20T12:56:58-07:00 · corroborated · grade: measured · author: main
  ...
  note: re-read after the commit that adds the `citation-slug` key. The section gained one more check, written like the two beside it and placed after them. The merge-renumber check is untouched and still refuses a value outside the three policies; the new check is placed above it and written the same way.
