...
and a red-team corpus of 96 seeds with committed expected outcomes proves the checkers.
...
the red-team corpus it was built against: 96 seeds, each a small ledger with committed
