...
and a red-team corpus of 80 seeds with committed expected outcomes proves the checkers.
...
the red-team corpus it was built against: 80 seeds, each a small ledger with committed
...
the corpus held at extraction still passes unchanged; it has since grown to 80.
