...
and a red-team corpus of 92 seeds with committed expected outcomes proves the checkers.
...
the red-team corpus it was built against: 92 seeds, each a small ledger with committed
